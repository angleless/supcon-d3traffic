...
import AspectsCode from './AspectsCode'
...
class Aspects extends Component {
  ...
  render () {
    ...
    return (
      <div id='cb-aspects-container' ref={el => { this.refD3 = el }} style={{ width: width, height: height, transformOrigin: '0 0' }}>
        <svg id='cb-aspects-svg' className='cb-flow-svg-zoomPan' viewBox={`0 0 ${w} ${h}`} width={w} height={h} style={{ background: `${background || 'transparent'}`, w, h }}>
          ...
          <g id='cb-aspects-symbols'>
            ...
            <symbol id='RIGHT_BACK' viewBox='0 0 1024 1024' width='22' height='22'>
  ...
  clearAllSvg () {
    ...
    this.refDom.select('#cb-aspects-group').selectAll('*').remove()
  ...
  allFunc () {
    const { isEdit, isDrawLaneDividers, isEditOut, showRoadName, isTurnDirections } = this.state
    this.clearAllSvg()
    // // 绘制背景色
    this.roadBg()
    // 绘制svg中心点
  ...
  svgHandleFunc () {
    const self = this
    this.refDom.select('#cb-aspects-svg')
      .attr('cursor', 'grab')
      .on('mousedown', function () {
        ...
        self.refDom.select('#cb-aspects-svg')
  ...
  drawSVG (aspectData, w, h) {
    ...
    const { x, y } = center
    const svg =
      this.refDom.select('#cb-aspects-group')
...
Aspects.AspectsCode = AspectsCode
Aspects.propTypes = {
