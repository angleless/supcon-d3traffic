...
import { getRestLength, deepCopy } from './utils'
...
class GreenWaveBand extends React.Component {
  componentDidMount () {
    this.renderCanvas()
  }
  ...
  renderCanvas () {
    ...
    getRestLength(data, ({ timeStart, distance, timeEnd, isCophase }) => this.addPath([timeStart, distance], [timeEnd, distance], styles.colors[isCophase], 3, offset))
  }
